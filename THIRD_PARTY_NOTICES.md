...
The release bundle includes the following projects. Their full license texts and source links must remain available with distributions.

- Truce 6.3.0 — Truce License 1.0 (MIT or Apache-2.0 grant with the Truce Framework Rider); full text: `THIRD_PARTY_LICENSES/Truce-License-1.0.txt` — https://github.com/truce-audio/truce/blob/v6.3.0/LICENSE
